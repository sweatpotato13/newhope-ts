...
export default class NewHope {
    ...
    generateKeyPair(): void {
        ...
        const nttS = utils.NTT(arrS, arrS.length, NewHopeConfig.bitRev_psi_12289_1024, q);
    ...
    generatePublicKey(): number[] {
        ...
        const nttE = utils.NTT(arrE, arrE.length, NewHopeConfig.bitRev_psi_12289_1024, q);
    ...
    generateSharedRandomness(): number[] {
        ...
        this._sharedRandomness = utils.NTT(arrA, arrA.length, NewHopeConfig.bitRev_psi_12289_1024, q);
    ...
    generateSharedSecret(otherPublicKey: number[], encoding: Encoding): number[] | string {
        ...
        const v1 = utils.INTT(nttV1, nttV1.length, NewHopeConfig.bitRev_psiInv_12289_1024, q, NewHopeConfig.INVN);
        // -------- Rec --------
    ...
    generateVector(otherPublicKey: number[]): void {
        ...
        const v = utils.INTT(nttV, nttV.length, NewHopeConfig.bitRev_psiInv_12289_1024, q, NewHopeConfig.INVN);
